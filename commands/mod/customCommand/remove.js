...
const deleteHandler = async (interaction, commandName) => {
	...
	return interaction.editReply({ embeds: [successEmbed(`Pomyślnie usunięto: \`${commandName}\` z komend.`)] }).catch(console.error);
};

export default {
	...new SlashCommandSubcommandBuilder()
		.setName('remove')
		.setDescription('Pozwala na usunięcie komendy z serwera.')
		.addStringOption(o =>
			o.setName('cmd_name')
